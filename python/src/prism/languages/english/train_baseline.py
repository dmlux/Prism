...
def parse_training_arguments(
    ...
    parser = argparse.ArgumentParser(
        description="Train an English student baseline.",
    )
    parser.add_argument(
        "--language-tag",
        choices=("en",),
...
def main() -> None:
    ...
    training_profiles = english_training_profiles_for_language_tag(
    ...
    schema_training_tokens = training_tokens
    ...
    training_corpus = encode_english_sentences(
        training_tokens,
        schema=schema,
    )
    ...
    bundle_training_corpus = training_corpus
    morphology_bundle_reranker_spec = (
        None
        ...
        torch.save(
            {
                ...
                "schema_language_tags": tuple(
                    ...
                    for schema_profile in ENGLISH_PROFILES
                ),
