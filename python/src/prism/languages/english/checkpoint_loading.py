"""Strict, reusable loading of English token-tagger checkpoints.
...
from prism.data import build_english_schema
...
def load_english_token_tagger(
    *,
    ...
    if not isinstance(checkpoint_language_tag, str) or any(
        not english_model_supports_language_tag(
    ...
    backbone_spec = schema_profiles[0].backbone_for_model_id(
