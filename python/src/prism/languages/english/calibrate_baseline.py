"""Fit per-task-head temperatures for an English checkpoint.
...
def parse_calibration_arguments(
    ...
    parser.add_argument(
        ...
        choices=("en",),
        default="en",
        help="Development data used for the fit.",
    )
    parser.add_argument(
        "--treebank-release",
...
def main() -> None:
    ...
    calibration_profiles = english_training_profiles_for_language_tag(
