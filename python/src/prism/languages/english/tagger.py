...
class EnglishTagger:
    """Frozen-checkpoint English tagger with calibrated confidences."""
    ...
    def __init__(
        ...
        *,
        ...
        loaded = load_english_token_tagger(
        ...
        self._segmentation_policy = english_sentence_extraction_policy(
